 ...
 */
public class UsersLoggedInFragment extends Fragment {
    private int pWidth;
    private int pHeight;
    private int width;
    private int y;
    ...
    public UsersLoggedInFragment(int width, int height,int y){
        this.pWidth=width;
        this.pHeight=height;
        this.y=y;
    }
    ...
    public void animate(){
        ...
        animation.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animator) {
                ((MainActivity)getActivity()).removeFragment(UsersLoggedInFragment.this);
            }
